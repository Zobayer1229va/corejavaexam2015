...
public static void main(String[] args){
	...
	empInfo = new EmployeeInfo(1, "Employee one");
	empInfo.employee.department = "Tester";
	empInfo.employee.salary = 4200;
	empInfo.employee.commission = 0.05;
	empInfo.employee.year = 2;
	ManageEmployees.employees.add(empInfo.employee);

	empInfo = new EmployeeInfo(2, "Employee Two");
	empInfo.employee.department = "Development";
	empInfo.employee.salary = 4500;
	empInfo.employee.commission = 0.07;
	empInfo.employee.year = 2;
	ManageEmployees.employees.add(empInfo.employee);
	
	empInfo = new EmployeeInfo(3, "Employee Three", "QA");
	empInfo.employee.salary = 5500;
	empInfo.employee.commission = 0.05;
	empInfo.employee.year = 2;
	ManageEmployees.employees.add(empInfo.employee);
	
	empInfo = new EmployeeInfo(4, "Employee Four", "Financial", 5000);
	empInfo.employee.commission = 0.6;
	empInfo.employee.year = 5;
	ManageEmployees.employees.add(empInfo.employee);
	
	empInfo = new EmployeeInfo(5, "Employee Five", "HR", 7000);
